      ...
      <div className="flex flex-col h-full p-4 relative">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 mt-1">
              <span className="flex items-center gap-1.5 bg-gray-50 px-2.5 py-1 rounded-full truncate group-hover:bg-blue-50/50 group-hover:text-blue-600 transition-all duration-300">
                ...
                <span className="truncate">{communityDetails?.num_member}+ members</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-auto flex-shrink-0">
          {firstOffering ? (
            ...
            <div className="flex items-center justify-center p-4 bg-gradient-to-r from-gray-50/50 to-gray-100/50 backdrop-blur-sm rounded-xl border border-gray-200/50
              group-hover:from-gray-100/50 group-hover:to-gray-200/50 transition-all duration-500"
            >
              <p className="text-muted text-sm font-medium">No Offering Available</p>
            </div>
          )}
        </div>
      </div>
