...
function MemoizedCommunityCard({ community, onClick }: { community: any; onClick: (id: string) => void }) {
    return (
        <Card
        ...
        >
          ...
          <div className="p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              />
              <h3 className="font-semibold text-white text-[18px]">{community.name}</h3>
            </div>
