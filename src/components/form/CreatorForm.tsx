    ...
    <Dialog defaultOpen>
      <DialogContent className="sm:max-w-[425px] bg-[#1C1C1C] text-white">
        <DialogHeader className="flex flex-row items-center justify-between">
          <DialogTitle className="text-xl font-normal">Fill to become a creator</DialogTitle>
        ...
        <div className="space-y-6 py-4">
          <div className="space-y-2">
            ...
            <Input placeholder="Enter name" className="bg-[#2C2C2C] border-none" />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label>Tags</Label>
            <Input placeholder="Enter Tags" className="bg-[#2C2C2C] border-none" />
          </div>
          <div className="space-y-2">
            <Label>Community Description</Label>
            <Textarea placeholder="Type anything" className="bg-[#2C2C2C] border-none min-h-[100px]" />
          </div>
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" className="text-white hover:text-purple-500 hover:bg-transparent p-0">
                  Connect
                </Button>
              </div>
              <div className="flex items-center justify-between">
