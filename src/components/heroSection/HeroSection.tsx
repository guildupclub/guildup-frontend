    ...
    <div className="min-h-[90vh] bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20 pb-16">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <motion.div 
            className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-gray-200/50 md:border-gray-200/50 text-gray-700 md:text-gray-700 px-4 py-2 md:px-6 md:py-3 rounded-full text-sm font-medium mb-6 md:mb-8 shadow-lg"
          ...
          >
            ...
            <div className="md:hidden grid grid-cols-3 gap-2 max-w-sm mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-green-100 text-center">
                ...
                <span className="text-xs font-semibold text-gray-800">Accelerate Growth</span>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100 text-center">
                ...
                <span className="text-xs font-semibold text-gray-800">1:1 Guidance</span>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-purple-100 text-center">
                ...
                <span className="text-xs font-semibold text-gray-800">Achieve Goals</span>
              </div>
            </div>
              ...
              <div className="flex flex-wrap justify-center gap-2 max-w-sm mx-auto">
                {suggestionButtons.slice(0, 6).map((suggestion, index) => {
                  ...
                  return (
                    ...
                    >
                      {suggestion === "Diet and Nutrition" ? "Diet & Nutrition" : 
                       suggestion === "Relationship Issues" ? "Relationships" :
                       suggestion === "Stress Management" ? "Stress Relief" : 
                       suggestion === "Self-Awareness" ? "Self-Growth" : suggestion}
                    </button>
                  );
                })}
              </div>
