...
export const useTracking = () => {
  ...
  const trackUserAction = useCallback((
    action: 'join_community' | 'create_post' | 'book_session' | 'make_payment' | 'send_message' | 'free_booking_confirmed' | 'paid_booking_confirmed' | 'paid_booking_confirmed_v2' | 'paid_booking_confirmed_v3' | 'user_registered' | 'user_signed_in' | 'user_signed_up'| 'bank_details_saved' |'signup_completed' | 'creator_form_opened'  |'signup_prompt_shown',
