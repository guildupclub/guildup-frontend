...
export default function ProgramPageClient({ programKey }: { programKey: ProgramKey }) {
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0" style={{ backgroundColor: white }}>
      ...
      {/* CTA Button after Symptoms */}
      <section className="py-8 sm:py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-center">
            <button
              onClick={() => window.open(whatsappUrl, '_blank')}
              className="px-8 py-4 rounded-xl shadow-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl"
              style={{
            ...
            >
              Facing these symptoms? Get help on WhatsApp
              <svg
