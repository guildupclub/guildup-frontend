      ...
      try {
        ...
        try {
          ...
          if (resp.ok) {
            ...
            // Local filter for Body categories (by category fields or tags/name keywords)
            const desiredIds = new Set(BODY_CATEGORY_IDS);
          ...
          console.error("JSON fallback failed for body communities:", jsonErr);
        }
      }
